        ...
        return (
            <div className=''>
                ...
                {products.map(product => (
                    <div key={product._id} className='bg-gray-200 mb-6'>
                        <div className='p-5'>
                        ...
                        <div className='bg-gray-200 h-'>
                            <div className='flex max-w-[1200px] mx-auto bg-white'>
                                <div className='w-[30%] p-5'>
                                    <img src={product.images[0].url} alt={product.name} className='w-full h-auto object-cover' />
                                    <div className='mt-5'>
                                        <ul className='flex'>
                                            {product.images.map((img, index) => (
                                                <li key={index} className='w-[70px] h-[70px] m-2'>
                                ...
                                <div className='w-[65%] p-5 border-gray-200 border-l'>
                                    ...
                                    <h2 className='text-[34px] font-[600] text-red-500'>{product.price.toLocaleString()}₫</h2>
                          ...
                          <div>
                            ...
                            <div className='p-2'>
                                <table className='border-[#eeeeee] w-full h-[20px] '>
                                    <tr>
                                        <td className='bg-[#f7f7f7] border-[#eeeeee] border'>Mainboard</td>
                                        <td className='bg-white  border-[#eeeeee] border'>MSI MAG Z790 TOMAHAWK MAX WIFI DDR5</td>
                                        <td className='bg-white border-[#eeeeee] border' >36 Tháng</td>
                                    </tr>
                                </table>
                            </div>
                          </div>
